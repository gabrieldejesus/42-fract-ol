...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/08 08:02:19 by gde-jesu          #+#    #+#             */
/*   Updated: 2023/09/27 12:45:54 by gde-jesu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_mandelbrot(t_data *vars)
{
	while (vars->y < HEIGHT)
	{
		...
		while (vars->x < WIDTH)
		{
			...
			vars->iteration = get_iteration_mandelbrot(vars->c);
